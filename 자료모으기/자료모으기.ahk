...
Loop, parse, jisa, `,
{
	...
	;화면정리
	ClsWindows:
	mouseclick, left, 1580,100
	sleep, 1000
	coordmode,mouse,relative
	mouseclick,left, 34,82
	sleep, 1000
	mouseclick, left, 350,50
	sleep,1000
	coordmode,mouse,screen
	mouseclick, left, 750,70
	send, {right}
	send, {down}
	send, {right}
	send, {down}
	...
	search:
	loop{
		pixelsearch,xx,xy,100,300,150,350,0x333333,,RGB  ;123,321좌표에서 0x000000이 나타날때까지 계속 찾는다.
		if ErrorLevel=0
		{
